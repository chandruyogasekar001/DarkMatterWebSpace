...
const apps = [
  { id: 1, icon: icon1, label: 'Galaxy blog', description: 'Description for App 1', website: 'https://blog-app-mern-dun.vercel.app/' },
  { id: 2, icon: icon2, label: 'Autobot AI', description: 'Description for App 2', website: 'https://autobot-ai-two.vercel.app/' },
